  ...
  render() {
    return (
      <div>
        ...
        <hr className='margin-y-50' />
        <div className=''>
          <p className='BackgroundDemo-trigger' style={ { border: '1px solid red' } }>
        ...
        <hr className='margin-y-50' />
        <div className='BackgroundDemo-endTrigger' style={ { border: '1px solid blue' } }>
          <Plx
            className='ColorDemo'
            parallaxData={ [
              {
